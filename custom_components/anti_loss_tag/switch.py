...
async def async_setup_entry(
    ...
    async_add_entities(
        [AntiLossTagDisconnectAlarmPolicySwitch(device, entry)], update_before_add=False
    )
...
class AntiLossTagDisconnectAlarmPolicySwitch(AntiLossTagEntityMixin, SwitchEntity):
    ...
    async def async_turn_on(self, **kwargs) -> None:
        ...
        await self._dev.async_set_disconnect_alarm_policy(
            True,
            force_connect=not self._dev.maintain_connection,
        )
